...
public class Utility_ClassTT {
	...
	public static void TakesScreenShot(WebDriver driver, String TCName) throws IOException
	{
		...
		File Destination = new File("C:\\Atul\\Screenshot_Timesheet\\Function="+TCName+" "+date+".jpg");
